...
public class UCSBOrganizationWebIT extends WebTestCase {
  ...
  public void admin_user_can_create_edit_delete_ucsborganization() throws Exception {
    ...
    page.getByTestId("UCSBOrganizationForm-orgCode").fill("SBHACKS");
    page.getByTestId("UCSBOrganizationForm-orgTranslationShort").fill("SB Hacks");
    page.getByTestId("UCSBOrganizationForm-orgTranslation").fill("SB Hacks Organization");
    page.getByTestId("UCSBOrganizationForm-submit").click();

    assertThat(page.getByTestId("UCSBOrganizationTable-cell-row-0-col-orgCode")).hasText("SBHACKS");
    assertThat(page.getByTestId("UCSBOrganizationTable-cell-row-0-col-orgTranslation"))
        .hasText("SB Hacks Organization");
    ...
    page.getByTestId("UCSBOrganizationForm-orgTranslation").fill("The SB Hacks Organization");
    page.getByTestId("UCSBOrganizationForm-submit").click();

    assertThat(page.getByTestId("UCSBOrganizationTable-cell-row-0-col-orgTranslation"))
        .hasText("The SB Hacks Organization");
